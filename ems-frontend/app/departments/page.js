            ...
            {departments.length === 0 ? (
              ...
              departments.map(department => (
                <tr key={department.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4 text-blue-700 font-medium whitespace-nowrap">{department.id}</td>
                  <td className="px-6 py-4 text-gray-900 font-semibold whitespace-nowrap">{department.name}</td>
